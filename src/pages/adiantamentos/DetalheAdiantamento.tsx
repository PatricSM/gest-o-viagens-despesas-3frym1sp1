    ...
    <div className="max-w-4xl mx-auto flex flex-col gap-6 animate-fade-in pb-12">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" onClick={() => navigate('/adiantamentos')}>
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <Badge
                variant="outline"
                className={
                  item.status === 'aprovado' || item.status === 'pago' || item.status === 'acertado'
          ...
          <Card className="shadow-sm">
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <p className="text-sm font-medium text-muted-foreground mb-1">Valor Solicitado</p>
